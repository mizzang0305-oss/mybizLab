...
| Two clean rehearsals | [GitHub run 35817773591](https://github.com/mizzang0305-oss/mybizLab/actions/runs/35817773591): access matrix and rollback PASS twice | does not exercise actual PostgREST HTTP or all app routes |
...
| SECURITY/PERFORMANCE_ADVISORS | NOT_RUN_ON_CANDIDATE | plain PostgreSQL fixture lacks Supabase advisors; Production baseline advisories must not be attributed to this draft |
