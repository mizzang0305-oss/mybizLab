...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '콘텐츠 QA', to: '/admin/content-quality' },
      { label: '버전/롤백', to: '/admin/versions' },
...
const pageTitles: Record<string, string> = {
  ...
  '/admin/sections': '페이지 섹션 관리',
  '/admin/seo': 'SEO 관리',
  '/admin/settings': '플랫폼 설정',
  '/admin/trust': '신뢰요소 관리',
  '/admin/versions': '버전/롤백',
