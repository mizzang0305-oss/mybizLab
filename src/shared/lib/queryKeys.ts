export const queryKeys = {
  ...
  customerContacts: (storeId: string) => ['customers', storeId, 'contacts'] as const,
  customerPreferences: (storeId: string) => ['customers', storeId, 'preferences'] as const,
  customerRecommendationActions: (storeId: string) => ['customers', storeId, 'recommendation-actions'] as const,
