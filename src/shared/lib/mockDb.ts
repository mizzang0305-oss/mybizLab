...
function normalizeDatabase(database: Record<string, unknown>) {
  ...
  nextDatabase.review_submit_attempts =
    (database.review_submit_attempts as MvpDatabase['review_submit_attempts']) ?? seeded.review_submit_attempts;
  ...
  nextDatabase.customer_recommendation_actions =
    (database.customer_recommendation_actions as MvpDatabase['customer_recommendation_actions']) ??
    seeded.customer_recommendation_actions;
