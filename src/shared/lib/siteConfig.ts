...
export const SERVICE_DESCRIPTION =
  '마이비즈랩은 공개 스토어, QR 주문, 예약, 고객관리, AI 분석을 하나의 운영 대시보드로 연결하는 SaaS 플랫폼입니다.';
export const POLICY_UPDATED_AT = '2026년 3월 14일';
export const SUPPORT_PHONE_PLACEHOLDER = '070-XXXX-XXXX';
...
export const BUSINESS_INFO = {
  ...
  customerCenter: SUPPORT_PHONE_PLACEHOLDER,
} as const;
...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    summary: '단일 매장의 주문과 기본 리포트를 빠르게 시작하는 플랜',
    features: ['매장 1개', 'AI 매장 분석', '기본 매출 리포트', 'QR 주문'],
  },
  {
    name: 'Pro',
    priceLabel: '월 79,000원',
    summary: '여러 매장을 운영하며 고객 경험과 분석 자동화를 강화하는 플랜',
  ...
  },
  {
    ...
    summary: '브랜드 단위 확장과 CRM 자동화를 고려한 고급 운영 플랜',
