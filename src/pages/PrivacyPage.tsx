...
export function PrivacyPage() {
  ...
  return (
    <LegalPageShell
      description="마이비즈랩은 서비스 제공에 필요한 최소한의 개인정보를 수집하며, 관련 법령에 따라 이를 안전하게 관리합니다."
      eyebrow="Privacy"
      title="개인정보처리방침"
    >
      <LegalSection title="1. 수집 항목">
        <p>담당자명, 이메일, 사업자 정보, 서비스 이용 기록, 결제 식별값 등을 수집할 수 있습니다.</p>
      </LegalSection>
      <LegalSection title="2. 수집 목적">
        <p>회원 식별, 계정 관리, 서비스 제공, 결제 및 환불 처리, 문의 대응, 서비스 개선을 위해 사용됩니다.</p>
      </LegalSection>
      <LegalSection title="3. 보관 기간">
        <p>목적 달성 후 지체 없이 파기하되, 관계 법령에 따라 보관이 필요한 정보는 해당 기간 동안 별도 보관할 수 있습니다.</p>
      </LegalSection>
      ...
      <LegalSection title="5. 처리 위탁 가능성">
        <p>호스팅, 이메일 발송, 결제 처리, 고객지원 등 일부 업무를 외부 전문 업체에 위탁할 수 있습니다.</p>
      </LegalSection>
      <LegalSection title="6. 이용자 권리">
        <p>이용자는 개인정보 열람, 정정, 삭제, 처리정지 요청을 할 수 있습니다.</p>
      </LegalSection>
      <LegalSection title="7. 문의 이메일">
        <p>
