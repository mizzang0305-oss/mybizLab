...
export function TermsPage() {
  usePageMeta('이용약관', '마이비즈랩 서비스 이용약관과 구독, 결제, 해지 기준을 확인하세요.');
  ...
  return (
    ...
    >
      <LegalSection title="1. 서비스 정의">
        <p>마이비즈랩은 공개 스토어 페이지, 메뉴 및 주문 화면, 관리자 대시보드와 운영 보조 기능을 제공하는 구독형 SaaS 서비스입니다.</p>
      </LegalSection>
      <LegalSection title="2. 회원가입 및 계정">
        <p>회원은 정확한 사업자 및 계정 정보를 기반으로 계정을 생성하고 관리해야 합니다.</p>
      </LegalSection>
      ...
      <LegalSection title="4. 구독 및 해지">
        <p>회원은 관리자 페이지 또는 고객센터를 통해 구독 해지를 요청할 수 있습니다.</p>
      </LegalSection>
      <LegalSection title="5. 환불 기준">
        <p>환불은 결제일, 이용 이력, 서비스 제공 범위, 관련 법령 및 환불정책에 따라 검토됩니다.</p>
      </LegalSection>
      <LegalSection title="6. 서비스 중단 및 변경">
        <p>시스템 점검, 장애 대응, 기능 개선이 필요한 경우 서비스 일부 또는 전부가 변경되거나 일시 중단될 수 있습니다.</p>
      </LegalSection>
      <LegalSection title="7. 책임 제한">
        <p>천재지변, 통신 장애, 외부 시스템 문제 등 회사의 합리적 통제를 벗어난 사유로 인한 손해에 대해서는 책임이 제한될 수 있습니다.</p>
      </LegalSection>
