...
type PricingTier = 'FREE' | 'PRO' | 'VIP' | 'Enterprise';
...
const comparisonRows: Array<{ feature: string; values: Record<PricingTier, CompareValue> }> = [
  { feature: 'AI 매장 분석', values: { FREE: true, PRO: true, VIP: true, Enterprise: true } },
  { feature: 'AI 비즈니스 리포트', values: { FREE: false, PRO: true, VIP: true, Enterprise: true } },
  { feature: '고객 관리', values: { FREE: false, PRO: true, VIP: true, Enterprise: true } },
  { feature: '예약 관리', values: { FREE: false, PRO: true, VIP: true, Enterprise: true } },
  { feature: '스케줄 관리', values: { FREE: false, PRO: false, VIP: true, Enterprise: true } },
  { feature: '설문 조사', values: { FREE: false, PRO: false, VIP: true, Enterprise: true } },
  { feature: '브랜드 관리', values: { FREE: false, PRO: false, VIP: true, Enterprise: true } },
  { feature: '매출 분석', values: { FREE: 'basic', PRO: 'advanced', VIP: 'advanced', Enterprise: 'enterprise' } },
  { feature: '주문 관리', values: { FREE: true, PRO: true, VIP: true, Enterprise: true } },
  { feature: '대기열 운영', values: { FREE: false, PRO: false, VIP: true, Enterprise: true } },
  { feature: '전자계약', values: { FREE: false, PRO: false, VIP: false, Enterprise: true } },
  { feature: 'QR 테이블오더', values: { FREE: true, PRO: true, VIP: true, Enterprise: true } },
];
