      ...
      <div className="mx-auto max-w-[84rem]">
        <div className="grid gap-8 lg:grid-cols-[.62fr_1.38fr]">
          ...
          <form className="rounded-[1.6rem] bg-[#f6f2ea] p-5 text-[#071019] sm:p-7" noValidate onSubmit={handleReview}>
            {selectionSummary ? <p className="mb-5 whitespace-pre-line rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-xs font-bold leading-6" data-inquiry-selection>{selectionSummary}</p> : null}
