...
values
  (
    ...
    'hero',
    'AI 운영 플랫폼, MyBiz',
    '고객을 기억할수록 매출이 쌓이는 시스템',
    '문의·예약·웨이팅·주문을 고객 기억 축으로 연결해 재방문과 객단가를 높입니다.',
    '공개 스토어에서 시작된 고객 신호가 상담, 예약, 웨이팅, 주문, 고객 기억으로 이어집니다.',
    '공개 스토어 시작하기',
    '/onboarding',
    '{"secondaryCtaLabel":"데모 보기","secondaryCtaHref":"/?demo=1","chips":["공개 스토어","고객 기억","운영 대시보드"]}'::jsonb,
    10,
    true,
    'published'
  ),
...
values
  ...
  (
    ...
    '결제 완료 후 store_subscriptions 반영으로 권한이 확정됩니다.',
    'PRO 시작',
    'checkout',
    null,
    true,
...
values (
  ...
  'one_time',
  'MyBiz 결제 테스트 100원',
  'PortOne checkout, redirect, verify, webhook, payment event 흐름을 확인하는 내부 테스트 상품입니다.',
  '["100원 단건 결제","구독 권한 변경 없음","PRO/VIP entitlement 부여 없음"]'::jsonb,
  false,
  true,
  false,
  'testPayment=1',
